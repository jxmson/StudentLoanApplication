...
namespace StudentLoan.Migrations
{
    ...
    [Migration("20210717104652_FixedApp")]
    partial class FixedApp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentLoan.Models.Entities.Application", b =>
                {
                    ...
                    b.Property<int?>("InstitutionSAUniversityId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ProgrammeSACoursesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InstitutionSAUniversityId");

                    b.HasIndex("MaritalStatusId");

                    b.HasIndex("OccupationId");

                    b.HasIndex("ProgrammeSACoursesId");

                    b.ToTable("Applications");
                });

            modelBuilder.Entity("StudentLoan.Models.Entities.Gender", b =>
                {
                    b.Property<int>("GenderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StudentLoan.Models.Entities.MaritalStatus", b =>
                {
                    b.Property<int>("MaritalStatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("MaritlStatusName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        ...
                        {
                            MaritalStatusId = 1,
                            MaritlStatusName = "Single"
                        },
                        new
                        {
                            MaritalStatusId = 2,
                            MaritlStatusName = "Married"
                        },
                        new
                        {
                            MaritalStatusId = 3,
                            MaritlStatusName = "Divorced"
                        });
                });

            modelBuilder.Entity("StudentLoan.Models.Entities.Occupation", b =>
                {
                    b.Property<int>("OccupationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StudentLoan.Models.Entities.Application", b =>
                {
                    b.HasOne("StudentLoan.Models.Entities.Gender", "Gender")
                        .WithMany()
                        .HasForeignKey("GenderId");

                    b.HasOne("StudentLoan.Models.SAUniversity", "Institution")
                        .WithMany()
                        .HasForeignKey("InstitutionSAUniversityId");

                    b.HasOne("StudentLoan.Models.Entities.MaritalStatus", "MaritalStatus")
                        .WithMany()
                        .HasForeignKey("MaritalStatusId");

                    b.HasOne("StudentLoan.Models.Entities.Occupation", "Occupation")
                        .WithMany()
                        .HasForeignKey("OccupationId");

                    b.HasOne("StudentLoan.Models.SACourses", "Programme")
                        .WithMany()
                        .HasForeignKey("ProgrammeSACoursesId");
